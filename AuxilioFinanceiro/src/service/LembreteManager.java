...
public class LembreteManager {
    ...
    private void carregarLembretes() {
        try {
            ...
            List<Mensalidade> mensalidades = (mensalidadeManager != null) ? mensalidadeManager.listarMensalidades() : new ArrayList<>();
    ...
    public void atualizarLembrete(int id, String novoTitulo, String novaDescricao, LocalDate novaData) throws ObjetoNaoEncontradoException, IOException, CampoVazioException {
